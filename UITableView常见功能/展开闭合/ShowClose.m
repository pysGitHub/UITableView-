...
@interface ShowClose ()<UITableViewDataSource,UITableViewDelegate>
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    if([self.isOpenArr[section] isEqualToString:@"1"])
    {
...
- (void)clickAction:(UITapGestureRecognizer *)g
{
    ...
    if ([self.isOpenArr[index] isEqualToString:@"1"]) {
        [self.isOpenArr replaceObjectAtIndex:index withObject:@"0"];
    }else{
        [self.isOpenArr replaceObjectAtIndex:index withObject:@"1"];
    }
